...
export default function Explanation() {
  return (
    <div className="text-gray-800 dark:text-gray-200 text-sm border border-dashed border-gray-300 dark:border-gray-600 p-4 mb-4 font-mono bg-white dark:bg-gray-900">
      <div className="mb-4">
        <Image
          src="/Vercel-AWS-GitHub-apg.png"
          alt="Vercel AWS Aurora PostgreSQL native integration"
          width={600}
          height={400}
      ...
      <p className="mb-2">
        This app uses <b className="font-bold">AWS Aurora PostgreSQL</b> with
        Next.js and Vercel (
        <Link
          href="https://github.com/uncurated-tests/aws-aurora-postgresql-demo"
          target="_blank"
          rel="noreferrer"
      ...
      <details className="group">
        <summary className="cursor-pointer hover:text-gray-900 dark:hover:text-white">
          <span className="pl-1">
            How is Aurora PostgreSQL different from other databases?
          </span>
        </summary>
        <p className="p-5 mt-2 bg-gray-100 dark:bg-gray-800">
          Our Aurora PostgreSQL database is replicated to multiple regions with{" "}
          <em className="text-gray-900 dark:text-gray-100 not-italic">
            strong consistency
          </em>
          . Aurora PostgreSQL is ACID-compliant, serverless, and separates
          storage from compute. It also has 99.99% availability in single-region
          configuration and 99.999% in multi-region.{" "}
          <Link
            href="https://aws.amazon.com/rds/aurora/postgresql-features/"
            target="_blank"
            rel="noreferrer"
            className="text-gray-900 dark:text-white border-b border-gray-900 dark:border-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
          >
